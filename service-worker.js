...
const STATIC_CACHE="travel-companion-static-v4-2-3";
const RUNTIME_CACHE="travel-companion-runtime-v4-2-3";
const APP_SHELL=[
  "./",
  "./index.html",
  "./assets/app.css?v=423-mobilephoto1",
  "./assets/app.js?v=423-mobilephoto1",
  "./manifest.webmanifest?v=423-mobilephoto1",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
